...
public class Cookbook extends JFrame implements MouseListener {
	...
	public void mouseClicked(MouseEvent e) {
		...
		if(e.getSource() == btnDelete) {
	        ...
	        if (selectedIndex != -1) {
	            int yn = JOptionPane.showConfirmDialog(null, "Are you sure you want to delete the selected recipe?",
	            ...
	            JOptionPane.showMessageDialog(null, "Please select a recipe to delete.", "No Recipe Selected",
		...
		if(e.getSource() == btnEdit) {
			...
			if(addRecipe.index==-1) {
				JOptionPane.showMessageDialog(null, "Please select a recipe to edit.", "No Recipe Selected", JOptionPane.WARNING_MESSAGE);
				return;
			}
		...
		if (e.getSource() == btnSave) {
            saveRecipes();
            JOptionPane.showMessageDialog(null, "Recipes are saved succesfully.");
        }
		
		if (e.getSource() == btnSort) {
		    int yn = JOptionPane.showConfirmDialog(null,"Are you sure you want to sort the recipes?","Sort Recipes",JOptionPane.YES_NO_OPTION);
		    if (yn == JOptionPane.YES_OPTION) {
