	...
	public void mouseClicked(MouseEvent e) {
		...
		if (e.getSource() == btnSearch) {
            ...
            if (searchIngredients.isEmpty()) {
                JOptionPane.showMessageDialog(null, "Please enter ingredients to search.", "Empty Search",
            ...
            if (dlmRecipes.isEmpty()) {
                JOptionPane.showMessageDialog(null, "No recipes found with the given ingredients.", "No Recipes Found",
                        JOptionPane.INFORMATION_MESSAGE);
            } else {
                JOptionPane.showMessageDialog(null, "Recipes found: " + dlmRecipes.size(), "Recipes Found",
                        JOptionPane.INFORMATION_MESSAGE);
            }
        }
